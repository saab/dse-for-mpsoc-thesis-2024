...
public class App {
    private static final String ARTIFACTS_DST = "src/main/java/platform/artifacts";
    private static final String FIODL_DST = ARTIFACTS_DST + "/platform.fiodl";
    private static final String KGT_DST = ARTIFACTS_DST + "/platform.kgt";

    public static void main(String[] args) throws Exception {
		// simple();
		var sGraph = CreatePlatformModel();
	...
	private static void simple() throws Exception { 
		...
		var model = handler.loadModel("src/main/java/platform/toy_sdf_tiny.fiodl");
		System.out.println(model.toString());
		handler.writeModel(model, "src/main/java/platform/platform.fiodl");
	}

	private static SystemGraph CreatePlatformModel() throws Exception {
